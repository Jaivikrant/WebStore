      ...
      {cart.length > 0 ? (
                    ...
                    <div className="grid grid-cols-2 py-2">
                      <div>
                        ...
                        <div className='flex flex-col items-start'>
                          <h4 className='text-black text-base font-bold font-inter tracking-normal leading-none pt-2'>
                            {item.name}
                          </h4>
                        </div>
                      ...
                      <div>
                        <p className='text-black text-xs font-inter font-bold tracking-normal leading-none pt-2'>
                          Selected Size : {" "}
                          <span className='ml-2'>
                            {item.size}
                          </span>
        ...
        <Fragment>
          ...
          >
            ...
            <DialogBody divider>
              <div>
                <h1 className='text-black text-3xl font-bold font-inter tracking-normal leading-none py-4'>
                  Your Cart is Empty
                </h1>
